...
var items = [
    ...
    ["story", "Form", {html: {include: 'John_bomb_belief_story_pillow.html'}}],
    ["story", "Form", {html: {include: 'John_bomb_fact_story_pillow.html'}}],

    ["story", "Form", {html: {include: 'Mary_bomb_belief_story_pillow.html'}}],
    ["story", "Form", {html: {include: 'Mary_bomb_fact_story_pillow.html'}}],
    ...
    ["test", "Form", html: {include: 'John_fact_question.html'}}],
    ["test", "Form", html: {include: 'John_belief_question.html'}}],

    ["test", "Form", html: {include: 'Mary_fact_question.html'}}],
    ["test", "Form", html: {include: 'Mary_belief_question.html'}}],
